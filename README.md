...
All data files live in the [`data/`](data/) folder. The paths below are relative to the repository root.

**Site category lists — use the one matching each item's `item_site_id`:**

| Site | site_id | File |
|---|---|---|
| US | 0 | [`data/usa_leaf_categories_site_id_0.csv`](data/usa_leaf_categories_site_id_0.csv) |
| UK | 3 | [`data/uk_leaf_categories_site_id_3.csv`](data/uk_leaf_categories_site_id_3.csv) |
| Germany | 77 | [`data/germany_leaf_categories_site_id_77.csv`](data/germany_leaf_categories_site_id_77.csv) |
| Motors | 100 | [`data/motors_leaf_categories_site_id_100.csv`](data/motors_leaf_categories_site_id_100.csv) |

**Item groups (~50 items each):**

- Group 1 — [`data/g1_items_SAP_category_data_37_111_1219.csv`](data/g1_items_SAP_category_data_37_111_1219.csv)
- Group 2 — [`data/g2_items_C2C_and_4or5_Seller_Seg_data_100_1219.csv`](data/g2_items_C2C_and_4or5_Seller_Seg_data_100_1219.csv)
- Group 3 — [`data/g3_items_Big_3_Sites_Data_100.csv`](data/g3_items_Big_3_Sites_Data_100.csv)
- Group 4 — [`data/g4_items_Hang_data_100_1229.csv`](data/g4_items_Hang_data_100_1229.csv)
...
**4. Code & packaging.**
Put all of your code in the [`code/`](code/) folder under the repository root (Python preferred; a TypeScript or Golang SDK is available on request). Keep everything in that one folder and include a reproducible way to run it — `uv`, a `requirements.txt`, or similar package management.
...
- **Roe SDK:** https://pypi.org/project/roe-ai/ (the SDK you'll need) · source: https://github.com/roe-ai/roe-python · docs: https://docs.roe-ai.com/ · local copy: [`sdk/pypi.md`](sdk/pypi.md)
